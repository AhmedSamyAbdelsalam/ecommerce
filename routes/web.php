...
Route::group(['middleware' => ['roles', 'role:admin|customer']], function () {
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::get('/forgot-password', [BackendController::class, 'forget_password'])->name('forget_password');
    });
    ...
    Route::group(['middleware' => ['roles', 'role:admin|supervisor']], function () {
        ...
        Route::post('product/remove_image',[ProductController::class,'remove_image'])->name('products.remove_image');
        ...
        Route::get('customer/get_customers',[CustomerController::class,'get_customers'])->name('customers.get_customers');
