                    ...
                    <div class="d-block mb-3 position-relative">
                        ...
                        <div class="product-overlay">
                            <ul class="mb-0 list-inline">
                                <li wire:click.prevent="addToWishList({{$relatedProduct->id}})" class="list-inline-item m-0 p-0">
                                    <a class="btn btn-sm btn-outline-dark">
                                        <i class="far fa-heart"></i>
                                    </a>
                                </li>
                                <li wire:click.prevent="addToCart({{$relatedProduct->id}})" class="list-inline-item m-0 p-0">
                                    <a class="btn btn-sm btn-dark">
                                        Add to cart
                                    </a>
                                </li>
                                <li class="list-inline-item mr-0">
                                    <a wire:click.prevent="$emit('showProductModalAction','{{$relatedProduct->slug}}')" class="btn btn-sm btn-outline-dark" data-target="#productView" data-toggle="modal">
