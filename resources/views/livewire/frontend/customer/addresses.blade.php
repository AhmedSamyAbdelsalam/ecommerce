<div x-data="{ formShow : @entangle('showForm') }">
    <div class="d-flex">
        <h2 class="h5 text-uppercase">ADDRESSES</h2>
        <button type="button" @click="formShow = true" class="ml-auto btn btn-primary">
            Add new address
        </button>
    </div>
    <form wire:submit.prevent="{{ $editMode ? 'update_address' : 'store_address' }}" x-show="formShow" @click.away="formShow = false">
        @if($editMode)
            <input type="hidden" wir:model="address_id" class="form-control">
        @endif
        <div class="row">
            ...
            <div class="col-lg-6 form-group">
                ...
                <input class="form-control form-control-lg" wire:model="address" type="text" placeholder="Enter your address">
                @error('address')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="address2">address2</label>
                <input class="form-control form-control-lg" wire:model="address2" type="text" placeholder="Enter your last address2">
