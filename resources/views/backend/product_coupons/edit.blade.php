...
@section('style')
    <link rel="stylesheet" href="{{asset('frontend/vendor/datepicker/themes/classic.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/vendor/datepicker/themes/classic.date.css')}}">
    <style>
...
@section('script')
    <script src="{{asset('frontend/vendor/datepicker/picker.js')}}"></script>
    <script src="{{asset('frontend/vendor/datepicker/picker.date.js')}}"></script>
    <script>
        $(function () {
            $('#code').keyup(function(){
