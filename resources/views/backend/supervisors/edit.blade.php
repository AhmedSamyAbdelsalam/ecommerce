                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <select name="permissions[]" class="form-control" id="select_multiple_tags" multiple="multiple">
                                @foreach($permissions as $permission)
                                    <option value="{{$permission->id}}" {{in_array($permission->id,old('permissions',$userPermissions)) ? 'selected' : null}}>{{$permission->display_name}}</option>
                                @endforeach
                            </select>
